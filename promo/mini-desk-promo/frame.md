...
description: >
  ...
  accent, the three-step gray text ladder, PingFang SC (display/numerals/chrome) + PingFang SC (body),
...
colors:
  # Mini Desk dark-aurora brand — 语义重排:预设为浅色体系,品牌为深色底浅色字
  bg: "#07090f"          # --bg 深空底
  primary: "#5eeabe"     # --accent 薄荷绿(eyebrow/kicker/圆点)
  text: "#eef2f8"        # --text 主墨色(浅)
  text-muted: "#a6b1c6"  # --text-2
  text-light: "#6d7890"  # --text-3
  accent-light: "rgba(94, 234, 190, 0.07)"    # color-mix(accent 7%)
  accent-medium: "rgba(94, 234, 190, 0.15)"
  border: "rgba(255, 255, 255, 0.09)"         # --line 中性细线,非强调色描边
  card-bg: "rgba(255, 255, 255, 0.045)"       # --panel 玻璃面板
  positive: "#059669"
  negative: "#dc2626"
  # aurora 渐变三元组(--g1 → --g2 → --g3, 100deg)用于大标题点睛行与 CTA:
  grad-1: "#5eeabe"
  grad-2: "#22d3ee"
  grad-3: "#a78bfa"
  violet: "#8b5cf6"      # --violet 第三强调,仅用于 wash/辉光,不作正文色
...
typography:
  # — reading ramp (PingFang SC body + PingFang SC chrome) —
  body:    { fontFamily: "PingFang SC", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "PingFang SC", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "PingFang SC", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "PingFang SC", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (PingFang SC, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "PingFang SC", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "PingFang SC", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "PingFang SC", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "PingFang SC", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "PingFang SC", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "PingFang SC", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "PingFang SC", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **PingFang SC** (display) / **SF Pro Display** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **PingFang SC** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **PingFang SC** (body, muted gray, line 1.6). Headlines are near-black;
...
- **PingFang SC** (display/numerals/chrome) + **PingFang SC** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (PingFang SC body 0.85cqw muted; PingFang SC eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (PingFang SC `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body PingFang SC 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line PingFang SC `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + PingFang SC label + muted desc + optional
...
blockquote, cite. **Focal** a PingFang SC `blockquote` near-black under a 15%-opacity cobalt
...
PingFang SC body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a PingFang SC `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body PingFang SC 400 muted, line 1.6.
...
- **Type** — PingFang SC headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; PingFang SC body muted line 1.6; ≥1.4cqw floor.
...
- **PingFang SC + PingFang SC via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
