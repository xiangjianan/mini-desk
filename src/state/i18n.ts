...
export const UI_TEXT = {
  zh: {
    ...
    app: {
      ...
      mobileHeroEyebrow: "MINI DESK · 桌面端优先",
      mobileHeroTitle: "完整工作台在桌面，随手速记在手机",
      mobileHeroLede: "工作台为电脑而生，手机打开这里，就是它的速记入口。",
      mobileDeskZoneAssets: "截图",
      mobileDeskZoneNotes: "便签",
      mobileDeskZoneTasks: "提醒",
      mobileDeskZoneSpaces: "空间",
      mobilePairTitle: "快速配对",
      mobilePairStep1: "电脑端打开「配对手机」面板",
      mobilePairStep2: "扫码或输入 12 位配对码",
      mobilePairStep3: "手机速记，自动同步到桌面",
      /* 已配对状态卡与同步提示卡。 */
      mobilePairedTitle: "已连接桌面端",
      mobilePairedNote: "已记住配对码，下次自动连接",
      mobileSyncNote: "内容每 5 分钟自动同步到桌面端",
      ...
      mobileInboxCodeHelp: "配对码在电脑端「配对手机」面板查看；空格自动忽略，I/L 视为 1、O 视为 0。",
      ...
      mobileInboxSendNote: "发送到便签",
      mobileInboxSending: "发送中…",
      mobileInboxSentButton: "已发送",
  ...
  en: {
    ...
    app: {
      ...
      mobileHeroEyebrow: "MINI DESK · DESKTOP FIRST",
      mobileHeroTitle: "The full workbench on desktop, quick capture on your phone",
      mobileHeroLede: "Built for the desktop — on your phone, it's the quick-capture entry.",
      mobileDeskZoneAssets: "Shots",
      mobileDeskZoneNotes: "Notes",
      mobileDeskZoneTasks: "Reminders",
      mobileDeskZoneSpaces: "Spaces",
      mobilePairTitle: "Quick pairing",
      ...
      mobilePairedTitle: "Connected to the desktop",
      mobilePairedNote: "Pairing code remembered — reconnects automatically",
      mobileSyncNote: "Captures sync to the desktop every 5 minutes",
      ...
      mobileInboxCodeHelp: "Find the code in the desktop “Pair phone” panel; spaces are ignored (I/L = 1, O = 0).",
