...
export const UI_TEXT = {
  zh: {
    ...
    app: {
      ...
      inboxQueueHint: "队列上限 200 条；写满后轮换配对码即可重置队列。",
      inboxCodeLabel: "配对码",
      ...
      mobileInboxErrorQueueFull: "收件队列已满，请在电脑端轮换配对码",
  ...
  en: {
    ...
    app: {
      ...
      inboxQueueHint: "Queue holds up to 200 items; rotate the pairing code to reset it when full.",
      ...
      mobileInboxErrorQueueFull: "Inbox queue is full; rotate the pairing code on your desktop",
