...
export const EMPTY_HINTS_BY_LANGUAGE = {
  ...
  en: {
    ...
    quickButtons: "Turn reusable destinations or text into actions.",
    todos: {
...
export const AREA_HELP_BY_LANGUAGE: Record<AppLanguage, Record<"images" | "note" | "quickButtons" | "todos" | "workspace" | "storage", string>> = {
  zh: {
    ...
    note: "便签区：先收住临时想法。",
    quickButtons: "快捷区：常用链接、文本和步骤一键执行。",
    todos: "提醒区：标题可双击改名。",
  ...
  en: {
    ...
    quickButtons: "Quick Actions: run links, snippets, and steps.",
...
export const CONTROL_HELP_BY_LANGUAGE: Record<AppLanguage, Record<"clearCompleted" | "addQuick" | "toggleHiddenQuick" | "settings" | "theme", string>> = {
  ...
  en: {
    ...
    addQuick: "Add a quick action",
    toggleHiddenQuick: "Show or hide hidden actions",
...
export const GUIDE_MESSAGES: Record<AppLanguage, Record<GuideKey, string[]>> = {
  ...
  en: {
    ...
    quickButtons: [
      ...
      "Use the menu to add a quick action.",
      "Show hidden items to recover low-use actions.",
      "Hiding an action never deletes its data.",
      "An action needs both title and content.",
      "Common snippets can become quick actions.",
    ...
    addQuick: [
      ...
      "Link is the default action type.",
    ...
    toggleHiddenQuick: [
      ...
      "Low-use actions can stay tucked away.",
...
export const UI_TEXT = {
  zh: {
    ...
    app: {
      ...
      quickActionAdded: "已新增快捷动作",
      todosCreatedFromText: "已转为提醒事项",
      gifDisabled: "已关闭 GIF",
      ...
      aboutDescription: "一个本地优先的轻量工作台，用来整理截图、便签、提醒事项、快捷动作和工作空间。",
  ...
  en: {
    ...
    app: {
      ...
      todosCreatedFromText: "Converted to reminders",
    ...
    note: {
      createTodos: "Convert to reminders",
      createQuick: "Make quick action",
    },
    images: {
