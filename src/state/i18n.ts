...
export const UI_TEXT = {
  zh: {
    ...
    app: {
      ...
      dirty: "有未保存内容",
      densityGood: "工作空间清爽",
      densityWarning: "有区域内容偏多",
      densityCrowded: "多个区域内容过多",
      theme: "切换主题",
      unnamedList: "未命名列表",
      newSpace: "新空间",
  ...
  en: {
    ...
    app: {
      ...
      densityGood: "Workspace feels light",
      densityWarning: "One area has too much",
      densityCrowded: "Multiple areas are crowded",
      theme: "Switch theme",
