...
export const UI_TEXT = {
  zh: {
    ...
    preview: {
      ...
      thumbnailAlt: "预览缩略图",
      imageAlt: "图片预览",
      help: "上下按钮/WASD 切换图片 · 双击缩放 · 拖动平移 · Enter 编辑/保存 · 5 复制 · Delete 删除 · Space/Esc 关闭",
    },
    imageEditor: {
      title: "编辑图片",
      tools: "图片编辑工具",
  ...
  en: {
    ...
    preview: {
      ...
      help: "Stacked buttons/WASD switch images · Double-click zooms · Drag pans · Enter edits/saves · 5 copies · Delete removes · Space/Esc closes",
    },
    imageEditor: {
      title: "Edit image",
