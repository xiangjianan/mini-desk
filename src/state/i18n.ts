...
export const UI_TEXT = {
  zh: {
    ...
    preview: {
      ...
      thumbnailAlt: "预览缩略图",
      imageAlt: "图片预览",
      help: "上下按钮/WASD 切换图片 · 双击缩放 · 拖动平移 · 5/Enter 复制 · Delete 删除 · Space/Esc 关闭",
    },
  },
  en: {
    common: {
    ...
    preview: {
      ...
      help: "Stacked buttons/WASD switch images · Double-click zooms · Drag pans · 5/Enter copies · Delete removes · Space/Esc closes",
    },
  },
} as const;
